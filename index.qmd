...
## Results
Results across all models and response variables are summarised in @fig-forest-plot and @tbl-models-summary-full. Stone pile construction produced no significant effect on catfish abundance, biomass, or occupancy relative to control sites across any model or time period (@fig-forest-plot), indicating stone piles did not attract catfish.
...
tidy_all_full <- readr::read_csv(file.path("outputs", "tbl-models-summary-full.csv"),
                                  show_col_types = FALSE)
