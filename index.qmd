...
@fig-descriptive-context



### multi-scale hierarchical framework
Lake scale:
source population catfish (Te Weta Bay)
...
Slope
Site type
stone pile placement: depth, distance shore, volume (Depth: rho = 0.90, p = 0.083 — very strong positive correlation)

Temporal scale:
Season/ monitoring round
Temperature
DO/ pH/ conductivity
Catfish CPUE
Habitable depth
