...
## Abstract {.unnumbered}
Kōura (*Paranephrops planifrons*), Aotearoa New Zealand's endemic freshwater crayfish, have declined by up to 96 % in Lake Rotoiti, driven by the invasive brown bullhead catfish (*Ameiurus nebulosus*) and thermal stratification compressing suitable habitat into the shallow littoral zone. As neither stressor can be eliminated at lake scale, we tested whether stone pile structures deployed in the littoral zone of Lake Rotoiti could provide structural refuge for kōura. Kōura and catfish were monitored at five stone pile, five control, and ten natural rocky reference sites for 18 months using a before-after control-impact (BACI) design and a two-method Bayesian occupancy model. Stone pile construction produced no detectable step-change in kōura abundance, biomass, or occupancy relative to control sites. Although no significant BACI effect was detected, effects consistently trended in the positive direction, with stone pile sites showing higher kōura occupancy and abundance than control sites after deployment, and continued monitoring is needed to determine whether this trend strengthens over time. Stone piles attracted no additional catfish. Stone pile use by kōura is inherently seasonal, with structures most valuable when habitat compression and catfish predation pressure peak simultaneously in summer and autumn. With both stressors expected to intensify under climate warming, the refuge value of stone piles is expected to increase, making early deployment an important strategy in refugia-limited lakes.
