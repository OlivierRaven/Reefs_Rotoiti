...
Kōura site occupancy was high across all sites types before and after construction. Warm-season occupancy estimats (summer and autumn combined) ranged from `r...` to `r...` across site type and periods  
...
@fig-cpue-power-plots + @fig-power-plots
