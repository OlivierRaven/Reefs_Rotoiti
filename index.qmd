...
if (!requireNamespace("sf", quietly = TRUE) || !requireNamespace("leaflet", quietly = TRUE)) {
  img <- if (file.exists("images/Rotoiti_monitoring_sites.png"))
    "images/Rotoiti_monitoring_sites.png"
  else
    "05_stone_piles_rotoiti/images/Rotoiti_monitoring_sites.png"
...
rotoiti <- sf::st_read(
  file.path(ch5_dir, "data/raw/Lake Rotoiti.gpkg"), quiet = TRUE
) |>
  sf::st_make_valid() |>
  sf::st_transform(4326)

site_info <- readr::read_csv(
  file.path(ch5_dir, "data/derived/Site_info.csv"), show_col_types = FALSE
) |>
...
site_info <- dplyr::mutate(site_info,
