...
group_levels <- c(
  "Baseline: stone pile vs control",
  "Baseline: Reference 1 vs Reference 2",
...
forest_data <- tidy_all %>%
  ...
  dplyr::mutate(
    row_label = dplyr::case_when(
      response_type == "abundance" ~ "Abundance",
      response_type == "biomass"   ~ "Biomass",
      response_type == "occupancy" ~ "Occupancy",
      TRUE ~ response_type),
    group = dplyr::case_when(
      RQ == "RQ1"  & comparison %in% c("vs_control", "treatment") ~ "Baseline: stone pile vs control",
      RQ == "RQ1"  & comparison == "reference" ~ "Baseline: Reference 1 vs Reference 2",
      RQ == "RQ2a" ~ "Construction impact: step-change",
      RQ == "RQ2b" ~ "Construction impact: trajectory",
      RQ == "RQ3a" ~ "Convergence toward reference",
  ...
  dplyr::arrange(
    ...
    factor(row_label,  levels = c("Abundance", "Biomass", "Occupancy"))) %>%
  dplyr::mutate(
...
ggsave(file.path(out_dir, "fig-forest-plot.png"), forest_plot, width = 6, height = 8, dpi = 300)
