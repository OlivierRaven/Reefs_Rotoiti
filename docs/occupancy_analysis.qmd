...
#| fig-width: 12
#| fig-height: 5
p_combined_occ <- p_heat + p_lines
ggsave(file.path("outputs", "fig-power-plots.png"),
       p_combined_occ, width = 12, height = 5, dpi = 300)
p_combined_occ
```
...
#| fig-width: 12
#| fig-height: 5
p_combined_cpue <- p_heat_cpue + p_lines_cpue
ggsave(file.path("outputs", "fig-cpue-power-plots.png"),
       p_combined_cpue, width = 12, height = 5, dpi = 300)
p_combined_cpue
```
