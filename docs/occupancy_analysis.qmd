...
#| fig-cap: "Simulation-based power curves for the occupancy BACI (left) and kōura CPUE BACI (right). Each line represents a different number of After-period monitoring rounds. Dashed line marks 80% power. Neither analysis reaches 80% power within the simulated range, reflecting the dominant contribution of between-pair variance."
#| fig-width: 12
#| fig-height: 5
