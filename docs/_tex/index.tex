...
at stone pile as control sites (β = -0.41, \emph{p} = 0.004), with the
sharpest decline observed in Winter 2026
(Figure~\ref{fig-koura-trends}).

Kōura site occupancy was high across all sites types before and after
construction. Warm-season occupancy estimats (summer and autumn
combined) ranged from \texttt{r...\ to}r\ldots{}

\textbf{?@fig-occ-warm-contrasts}

\textbf{?@tbl-psi-warm}

\textbf{?@fig-trajectory-projection}

\textbf{?@fig-cpue-power-plots} + \textbf{?@fig-power-plots}
...
types, rulling out temperature as a site specific driver.and therefore
...
is deeper (\citeproc{ref-Blanchfield2026}{\textbf{Blanchfield2026?}}).
For kōura this means that during spring and summer the threat of catfish
is highest and habitat compression during this period also being
...
multiple species and threats
(\citeproc{ref-Selwood2020}{\textbf{Selwood2020?}}) the value of
restoration and expanding the availability of this habitat can be very
important
