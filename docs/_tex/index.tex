...
\urlstyle{same}
\hypersetup{
  pdftitle={Reinforcing kōura resilience using rock piles to enhance freshwater crayfish habitat in a Aotearoa New Zealand lake},
...
\title{Reinforcing kōura resilience using rock piles to enhance
freshwater crayfish habitat in a Aotearoa New Zealand lake}
\usepackage{etoolbox}
\makeatletter
...
the difference between stone pile and reference sites. We fitted four
complementary generalised linear mixed effects models (GLMMs) to assess
...
a convergence model, testing whether stone pile sites approached
reference-sites densities over time; and a baseline and equivalence
model, testing whether treatment and reference sites were equivalent
before construction and after construction.

The construction-effect model combined all six post-construction
monitoring rounds into one factor level, retaining each round as a
separate observation. The occupancy response variable was fitted with a
Binomial family with logit link and the abundance and biomass with a
Tweedie familie loglink. In the model, period (before/after) and site
were fitted as an interaction, with monitoring number and temperature as
covariates and site nested within pair as a random effect.

The post-construction trend model tested the response variables kōura
catfish abundance or biomass fitted with Tweedie, site type and
monitoring number as interaction, temperature and substrate index from
before construction as covariates and site number as random effect.

The convergence model tested the response variables kōura catfish
abundance or biomass fitted with Tweedie, site type and monitoring
number as interaction, season and substrate index from post-construction
as covariates and site number as random effect.

The baseline and equivalent models tested the response variables kōura
catfish abundance or biomass fitted with Tweedie, site type as fixed
effect for the baseline and for the equivalente models the site type and
monitoring number as interaction and temperature as covariate and site
nested within pair as a random effect.

All models were fitted and validated in R (version 4.5.2; R Core Team
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0533}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0237}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0473}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0828}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0769}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0651}}
  >{\raggedright\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.2544}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0533}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0592}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0592}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0473}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0533}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0651}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0592}}@{}}
...
PeriodAfter:siteStone\_pile & 1.814 & 1.968 & 0.922 & 0.357 & 0.853 &
-2.043 & 5.671 \\
...
PeriodAfter:siteStone\_pile & 1.872 & NA & NA & NA & NA & NA & NA \\
M1ac & RQ1 & Catfish & abundance & vs\_control & full & (Intercept) &
-1.472 & NA & NA & NA & NA & NA & NA \\
...
PeriodAfter:siteStone\_pile & 4.954 & 5.473 & 0.905 & 0.365 & 0.853 &
-5.774 & 15.682 \\
...
& 0.269 & 2.328 \\
M2ac & RQ2 & Catfish & abundance & vs\_control & post & (Intercept) &
-21.188 & 23564.174 & -0.001 & 0.999 & NA & -46206.120 & 46163.743 \\
...
& -0.175 & 0.854 \\
M3ac & RQ3 & Catfish & abundance & vs\_reference & full & (Intercept) &
-20.757 & 10860.696 & -0.002 & 0.998 & NA & -21307.331 & 21265.816 \\
...
& -0.035 & 2.481 \\
M4TBak & RQ4 & Kōura & abundance & treatment & before & (Intercept) &
-1.897 & 0.785 & -2.415 & 0.016 & NA & -3.437 & -0.358 \\
M4TBak & RQ4 & Kōura & abundance & treatment & before &
Site\_type\_detailStone\_pile & 0.288 & 1.044 & 0.276 & 0.783 & 0.783 &
-1.759 & 2.334 \\
M4TBbk & RQ4 & Kōura & biomass & treatment & before & (Intercept) &
1.030 & 0.830 & 1.241 & 0.215 & NA & -0.597 & 2.656 \\
M4TBbk & RQ4 & Kōura & biomass & treatment & before &
Site\_type\_detailStone\_pile & 1.044 & 0.977 & 1.068 & 0.286 & 0.571 &
-0.872 & 2.959 \\
M4TBac & RQ4 & Catfish & abundance & treatment & before & (Intercept) &
-2.303 & 0.908 & -2.535 & 0.011 & NA & -4.083 & -0.522 \\
M4TBac & RQ4 & Catfish & abundance & treatment & before &
Site\_type\_detailStone\_pile & -0.693 & 1.535 & -0.452 & 0.652 & 0.783
& -3.701 & 2.315 \\
M4TBbc & RQ4 & Catfish & biomass & treatment & before & (Intercept) &
3.203 & 1.279 & 2.504 & 0.012 & NA & 0.696 & 5.709 \\
M4TBbc & RQ4 & Catfish & biomass & treatment & before &
Site\_type\_detailStone\_pile & -5.100 & 3.107 & -1.641 & 0.101 & 0.403
& -11.190 & 0.990 \\
M4RBak & RQ4 & Kōura & abundance & reference & before & (Intercept) &
0.742 & 0.553 & 1.343 & 0.179 & NA & -0.341 & 1.825 \\
M4RBak & RQ4 & Kōura & abundance & reference & before &
Site\_type\_detailReference\_2 & 0.031 & 0.778 & 0.040 & 0.968 & 0.968 &
-1.494 & 1.557 \\
M4RBbk & RQ4 & Kōura & biomass & reference & before & (Intercept) &
3.623 & 0.478 & 7.580 & 0.000 & NA & 2.686 & 4.560 \\
M4RBbk & RQ4 & Kōura & biomass & reference & before &
Site\_type\_detailReference\_2 & -0.041 & 0.681 & -0.061 & 0.952 & 0.968
& -1.375 & 1.293 \\
M4RBac & RQ4 & Catfish & abundance & reference & before & (Intercept) &
-1.050 & 0.715 & -1.467 & 0.142 & NA & -2.452 & 0.353 \\
M4RBac & RQ4 & Catfish & abundance & reference & before &
Site\_type\_detailReference\_2 & -0.336 & 1.074 & -0.313 & 0.754 & 0.968
& -2.442 & 1.769 \\
M4RBbc & RQ4 & Catfish & biomass & reference & before & (Intercept) &
4.989 & 1.054 & 4.731 & 0.000 & NA & 2.922 & 7.055 \\
M4RBbc & RQ4 & Catfish & biomass & reference & before &
Site\_type\_detailReference\_2 & -1.122 & 1.634 & -0.686 & 0.493 & 0.968
& -4.325 & 2.082 \\
M4TAak & RQ4 & Kōura & abundance & treatment & after & (Intercept) &
0.772 & 1.071 & 0.720 & 0.471 & NA & -1.328 & 2.871 \\
M4TAak & RQ4 & Kōura & abundance & treatment & after &
Site\_type\_detailStone\_pile & 0.054 & 0.795 & 0.067 & 0.946 & NA &
-1.505 & 1.612 \\
M4TAak & RQ4 & Kōura & abundance & treatment & after & monitoring\_int &
-0.299 & 0.165 & -1.820 & 0.069 & NA & -0.622 & 0.023 \\
M4TAak & RQ4 & Kōura & abundance & treatment & after & Temperature &
-0.053 & 0.044 & -1.226 & 0.220 & NA & -0.139 & 0.032 \\
M4TAak & RQ4 & Kōura & abundance & treatment & after &
Site\_type\_detailStone\_pile:monitoring\_int & 0.328 & 0.203 & 1.619 &
0.105 & 0.112 & -0.069 & 0.726 \\
M4TAbk & RQ4 & Kōura & biomass & treatment & after & (Intercept) & 3.154
& 0.872 & 3.618 & 0.000 & NA & 1.445 & 4.863 \\
M4TAbk & RQ4 & Kōura & biomass & treatment & after &
Site\_type\_detailStone\_pile & -0.378 & 0.996 & -0.379 & 0.704 & NA &
-2.329 & 1.574 \\
M4TAbk & RQ4 & Kōura & biomass & treatment & after & monitoring\_int &
-0.345 & 0.220 & -1.568 & 0.117 & NA & -0.775 & 0.086 \\
M4TAbk & RQ4 & Kōura & biomass & treatment & after &
Site\_type\_detailStone\_pile:monitoring\_int & 0.459 & 0.276 & 1.661 &
0.097 & 0.112 & -0.083 & 1.000 \\
M4TAac & RQ4 & Catfish & abundance & treatment & after & (Intercept) &
-2.243 & 1.629 & -1.377 & 0.169 & NA & -5.435 & 0.950 \\
M4TAac & RQ4 & Catfish & abundance & treatment & after &
Site\_type\_detailStone\_pile & -2.645 & 1.839 & -1.439 & 0.150 & NA &
-6.248 & 0.959 \\
M4TAac & RQ4 & Catfish & abundance & treatment & after & monitoring\_int
& -0.586 & 0.458 & -1.278 & 0.201 & NA & -1.484 & 0.313 \\
M4TAac & RQ4 & Catfish & abundance & treatment & after &
Site\_type\_detailStone\_pile:monitoring\_int & 1.166 & 0.586 & 1.990 &
0.047 & 0.112 & 0.018 & 2.315 \\
M4TAac & RQ4 & Catfish & abundance & treatment & after & (Intercept) &
-20.402 & 19359.257 & -0.001 & 0.999 & NA & -37963.849 & 37923.044 \\
M4TAbc & RQ4 & Catfish & biomass & treatment & after & (Intercept) &
3.571 & 2.008 & 1.778 & 0.075 & NA & -0.365 & 7.508 \\
M4TAbc & RQ4 & Catfish & biomass & treatment & after &
Site\_type\_detailStone\_pile & -6.432 & 4.577 & -1.405 & 0.160 & NA &
-15.402 & 2.539 \\
M4TAbc & RQ4 & Catfish & biomass & treatment & after & monitoring\_int &
-0.864 & 0.688 & -1.256 & 0.209 & NA & -2.212 & 0.484 \\
M4TAbc & RQ4 & Catfish & biomass & treatment & after &
Site\_type\_detailStone\_pile:monitoring\_int & 1.928 & 1.214 & 1.588 &
0.112 & 0.112 & -0.451 & 4.307 \\
M4RAak & RQ4 & Kōura & abundance & reference & after & (Intercept) &
-0.740 & 0.976 & -0.758 & 0.448 & NA & -2.652 & 1.173 \\
M4RAak & RQ4 & Kōura & abundance & reference & after &
Site\_type\_detailReference\_2 & -0.223 & 0.601 & -0.372 & 0.710 & NA &
-1.402 & 0.955 \\
M4RAak & RQ4 & Kōura & abundance & reference & after & monitoring\_int &
-0.169 & 0.094 & -1.801 & 0.072 & NA & -0.353 & 0.015 \\
M4RAak & RQ4 & Kōura & abundance & reference & after & Temperature &
0.071 & 0.034 & 2.091 & 0.037 & NA & 0.004 & 0.138 \\
M4RAak & RQ4 & Kōura & abundance & reference & after &
Site\_type\_detailReference\_2:monitoring\_int & -0.038 & 0.124 & -0.304
& 0.761 & 0.902 & -0.281 & 0.206 \\
M4RAbk & RQ4 & Kōura & biomass & reference & after & (Intercept) & 3.370
& 0.860 & 3.917 & 0.000 & NA & 1.683 & 5.056 \\
M4RAbk & RQ4 & Kōura & biomass & reference & after &
Site\_type\_detailReference\_2 & -0.184 & 0.737 & -0.250 & 0.803 & NA &
-1.630 & 1.261 \\
M4RAbk & RQ4 & Kōura & biomass & reference & after & monitoring\_int &
...
M4RAac & RQ4 & Catfish & abundance & reference & after & (Intercept) &
-6.715 & 1.788 & -3.757 & 0.000 & NA & -10.219 & -3.212 \\
M4RAac & RQ4 & Catfish & abundance & reference & after &
Site\_type\_detailReference\_2 & 0.731 & 1.033 & 0.707 & 0.479 & NA &
-1.295 & 2.756 \\
M4RAac & RQ4 & Catfish & abundance & reference & after & monitoring\_int
& -0.051 & 0.233 & -0.220 & 0.826 & NA & -0.509 & 0.406 \\
M4RAac & RQ4 & Catfish & abundance & reference & after & Temperature &
...
M4RAac & RQ4 & Catfish & abundance & reference & after & (Intercept) &
-20.018 & 13711.191 & -0.001 & 0.999 & NA & -26893.458 & 26853.421 \\
M4RAbc & RQ4 & Catfish & biomass & reference & after & (Intercept) &
2.128 & 1.527 & 1.393 & 0.163 & NA & -0.865 & 5.121 \\
M4RAbc & RQ4 & Catfish & biomass & reference & after &
Site\_type\_detailReference\_2 & 0.062 & 1.575 & 0.039 & 0.969 & NA &
-3.025 & 3.149 \\
M4RAbc & RQ4 & Catfish & biomass & reference & after & monitoring\_int &
...
M3ac & 0.473 & 0.374 & 1 \\
M3bc & 0.580 & 0.260 & 1 \\
M4TAak & 0.416 & 0.970 & 1 \\
M4TAbk & 0.825 & 0.866 & 1 \\
M4TAbc & 0.697 & 0.668 & 1 \\
M4RAak & 0.956 & 0.874 & 1 \\
M4RAbk & 0.872 & 0.896 & 1 \\
M4RAbc & 0.885 & 0.748 & 1 \\
