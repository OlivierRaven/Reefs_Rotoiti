...
\item
  ...
  provide structural refuge for kōura from predation.
\item
  Kōura and catfish were monitored at five stone piles, five control,
  and five paired natural rocky reference sites for 18 months using a
  quasi before-after control-impact (quasi-BACI) design, with kōura
  occupancy modelled using a Bayesian framework that incorporated
  detection probabilities from baited traps and fyke nets.
\item
  Although stone pile construction produced no statistically significant
  change in kōura abundance, biomass, or occupancy relative to control
  sites, effects consistently trended positive, with higher kōura
  occupancy and abundance at stone pile sites than control sites after
  deployment; catfish showed no comparable trend, indicating stone piles
  may attract kōura without also attracting catfish.
\item
  \textbf{Synthesis and applications.} Continued long-term monitoring is
  needed to determine whether the positive kōura trend strengthens over
  time. Kōura use of stone piles was predominantly seasonal, with
  structures most valuable when habitat compression and catfish
  predation pressure are predicted to peak simultaneously in summer and
  autumn. As both stressors are expected to intensify under climate
  warming, the refuge value of stone piles is likely to increase, making
  early deployment an important strategy in refugia-limited lakes.
\end{enumerate}
...
18 months. Physical characteristics of all sites are summarised in
...
nearshore littoral habitats (\citeproc{ref-Kusabs2026}{I. A. K. Kusabs
et al., 2026}) and when catfish predation pressure is highest in the
areas where the stone piles are located
(\citeproc{ref-Blanchfield2026}{Blanchfield et al., 2026}). The
...
(\citeproc{ref-Vehtari2021}{Vehtari et al., 2021}).
...
significantly higher at Reference 1 than Reference 2 (\emph{p} = 0.004
and \emph{p} = 0.002 respectively), despite both sites having comparable
...
in Winter 2026 (Figure~\ref{fig-cpue-trends}). Stone pile construction
...
changes the costs and benefits of hunting for the predator
...
\citeproc{ref-Thresher2013}{\textbf{Thresher2013?}}), but these remain
...
whether kōura abundance at stone pile sites continues to build over
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0459}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1009}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0734}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1468}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1101}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1009}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1651}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1193}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1376}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
1 & Stone\_pile & Rocky & 5.20 & 0.12 & 4.76 & 0 & 10 & 0 \\
2 & Control & Rocky & 4.40 & 0.11 & 4.79 & 70 & 0 & 0 \\
3 & Stone\_pile & Sandy & 3.00 & 0.01 & 1.71 & 100 & 0 & 0 \\
4 & Control & Sandy & 3.00 & 0.01 & 1.74 & 80 & 5 & 0 \\
5 & Stone\_pile & Sandy & 2.40 & 0.01 & 0.61 & 10 & 0 & 0 \\
6 & Control & Sandy & 3.00 & 0.01 & 0.55 & 0 & 0 & 0 \\
7 & Stone\_pile & Sandy & 3.00 & 0.06 & 2.50 & 100 & 0 & 0 \\
8 & Control & Sandy & 3.00 & 0.05 & 2.22 & 30 & 0 & 0 \\
9 & Stone\_pile & Sandy & 3.35 & 0.08 & 3.59 & 0 & 0 & 3 \\
10 & Control & Rocky & 5.00 & 0.09 & 3.74 & 20 & 0 & 0 \\
11 & Reference & Rocky & 6.60 & 0.16 & 4.47 & 0 & 0 & 0 \\
12 & Reference & Rocky & 6.20 & 0.12 & 4.17 & 100 & 100 & 0 \\
13 & Reference & Sandy & 3.60 & 0.09 & 1.71 & 100 & 100 & 0 \\
14 & Reference & Sandy & 3.50 & 0.11 & 1.65 & 100 & 100 & 0 \\
15 & Reference & Rocky & 5.20 & 0.03 & 1.44 & 100 & 100 & 6 \\
16 & Reference & Rocky & 5.20 & 0.04 & 1.40 & 100 & 100 & 2 \\
17 & Reference & Rocky & 5.00 & 0.05 & 3.47 & 100 & 100 & 30 \\
18 & Reference & Rocky & 6.20 & 0.05 & 3.46 & 100 & 100 & 7 \\
19 & Reference & Rocky & 5.70 & 0.11 & 2.63 & 100 & 100 & 4 \\
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{outputs/fig-forest-plot.png}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{outputs/fig-cpue-trends.png}
