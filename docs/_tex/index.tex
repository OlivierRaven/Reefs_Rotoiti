...
{[}{(Fig. S1)}{]} (\citeproc{ref-Froese2006}{Froese, 2006}). Predicted
values were back-transformed with a lognormal bias correction factor
(10\^{}\{0.5 \cdot \sigma\^{}2\}) (\citeproc{ref-Quinn2002}{Quinn \&
Keough, 2002}).
...
\emph{Baseline equivalence} Pre-construction baseline model showed no
significant difference between stone pile sites and
...
\textbf{?@fig-descriptive-context-ch5}
...
Trap catches alone cannot determine whether kōura are actively using
...
rocky substrates this is often not possible, and kōura may pass beneath
